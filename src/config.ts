...
export const KAKAO_REDIRECT_URI = `https://melo-diary.vercel.app/auth?type=kakao`;
...
export const NAVER_REDIRECT_URI = `https://melo-diary.vercel.app/auth?type=naver`;
